...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (IsOnStairs())
        {
            // Menerapkan gerakan yang lebih sesuai untuk tangga
            Vector3 movementOnStairs = (cameraForward * verticalInput + mainCamera.transform.right * horizontalInput).normalized;
            movementOnStairs.y = 0f; // Memastikan pemain tetap di atas tangga
